...
public class ClaimHelpCommand extends AbstractPlayerCommand {
    ...
    protected void execute(@Nonnull CommandContext ctx,
        ...
        playerData.sendMessage(Messages.helpEntry("claim", "Claim the chunk you're standing in"));
        ...
        playerData.sendMessage(Messages.helpEntry("trust <player>", "Trust a player in all your claims"));
